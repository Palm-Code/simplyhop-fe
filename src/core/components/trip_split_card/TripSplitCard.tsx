        ...
        >
          ...
          >
            {!imageError ? (
              <Image
                {...car.image}
                className={clsx("w-[75px]")}
                onError={handleImageError}
              />
            ) : (
              <div className={clsx("w-[75px] h-[46px]")} />
            )}
            {/* identity */}
                  ...
                  >
                    {car.facility?.top.map((item, index) => (
                      <CarFacilityItem
                        key={index}
                        icon={
                          { ...item.icon } as { name: SVGIconProps["name"] }
                        }
                        name={{ ...item.name }}
                      />
                    ))}
          ...
          {(cta || price) && (
            <div
              className={clsx(
                "flex items-center flex-row justify-between gap-[0.5rem]",
                "w-full h-full"
              )}
            >
              {/* price */}
