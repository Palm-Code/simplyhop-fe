...
export const SuccessCancelBookNotificationTripSupport = () => {
  ...
  const handleClose = () => {
    dispatch({
      type: TripSupportActionEnum.SetBookData,
      payload: {
        ...state.book,
        data: [],
        pagination: {
    ...
    dispatch({
      type: TripSupportActionEnum.SetSuccessCancelBookNotificationData,
      payload: {
    ...
    queryClient.invalidateQueries({
      queryKey: TripSupportReactQueryKey.GetBookingMy(payload),
      refetchType: "all",
      type: "all",
    });
