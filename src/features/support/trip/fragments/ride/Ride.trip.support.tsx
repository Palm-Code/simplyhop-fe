...
import { RideCardTripSupport } from "../../components/ride_card";
...
export const RideTripSupport = () => {
  ...
  const handleLoadMore = () => {
    ...
    dispatch({
      type: TripSupportActionEnum.SetRideDataPaginationCurrent,
  ...
  const handleClickShare = (data: { link: string; message: string }) => {
    dispatch({
      type: TripSupportActionEnum.SetShareRideNotificationData,
      payload: {
