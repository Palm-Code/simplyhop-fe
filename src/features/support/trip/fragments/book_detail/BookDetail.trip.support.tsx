...
import { BookDetailCardTripSupport } from "../../components/book_detail_card";
...
export const BookDetailTripSupport = () => {
  ...
  React.useEffect(() => {
    dispatch({
      type: TripSupportActionEnum.SetDetailBookNotificationData,
      payload: {
  ...
  const handleClickCancelBook = () => {
    ...
    dispatch({
      type: TripSupportActionEnum.SetCancelBookNotificationData,
      payload: {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <BookDetailCardTripSupport {...filteredData} />
          </div>
