...
export const CompanyTypeFormCreateOrganization = () => {
  const dictionaries = getDictionaries();
  const globalDictionaries = getGlobalDictionaries();
  const { state, dispatch } = React.useContext(CreateOrganizationContext);

  const handleSelectCompanyType = (data: { id: string; name: string }) => {
    dispatch({
      type: CreateOrganizationActionEnum.SetRidePlanData,
      payload: {
        ...state.company_data,
        form: {
      ...
      >
        ...
        >
          ...
          <Textfield
            ...
            error={
              state.company_data.form.responsible_person.first_name.error?.name
            }
          />
          {/* last_name */}
          <Textfield
            ...
            inputProps={{
              ...
              value: state.company_data.form.responsible_person.last_name.value,
              onChange: handleChangeLastName,
            }}
            error={
              state.company_data.form.responsible_person.last_name.error?.name
            }
          />
        </div>
      </div>
