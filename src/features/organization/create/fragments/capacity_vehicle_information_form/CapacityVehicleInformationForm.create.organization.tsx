...
export const CapacityVehicleInformationFormCreateOrganization = () => {
  ...
  const handleSelectAvailableSeat = (data: { id: string; name: string }) => {
    dispatch({
      type: CreateOrganizationActionEnum.SetVehicleInformationData,
      payload: {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p
          className={clsx(
            "text-[0.75rem] text-[#606060] dark:text-[#C3C3C3] font-normal"
          )}
        >
